...
const movieMasterData = {
  IRON_MAN: { name: 'Iron Man', nickname: 'IM1', id: 901 },
  THE_INCREDIBLE_HULK: { name: 'The Incredible Hulk', nickname: 'H1', id: 902 },
  IRON_MAN_2: { name: 'Iron Man 2', nickname: 'IM2', id: 903 },
  THOR: { name: 'Thor', nickname: 'Th1', id: 904 },
  CAPTAIN_AMERICA_FIRST_AVENGER: {
    name: 'Captain America: The First Avenger',
    nickname: 'CA:TFA',
    id: 905,
  },
  AVENGERS: { name: 'The Avengers', nickname: 'AV', id: 906 },
  IRON_MAN_3: { name: 'Iron Man 3', nickname: 'IM3', id: 907 },
  THOR_DARK_WORLD: { name: 'Thor: The Dark World', nickname: 'Th2', id: 908 },
  ...
  AVENGERS_AGE_OF_ULTRON: { name: 'Avengers: Age of Ultron', nickname: 'AV:AoU', id: 911 },
  ANT_MAN: { name: 'Ant-Man', nickname: 'AM', id: 912 },
  CAPTAIN_AMERICA_CIVIL_WAR: {
    name: 'Captain America: Civil War',
    nickname: 'CA:CW',
    id: 913,
  },
  DOCTOR_STRANGE: { name: 'Doctor Strange', nickname: 'DS', id: 914 },
  GUARDIANS_OF_THE_GALAXY_2: {
    name: 'Guardians of the Galaxy Vol. 2',
    nickname: 'GotG2',
    id: 915,
  },
  SPIDER_MAN_HOMECOMING: { name: 'Spider-Man: Homecoming', nickname: 'SM:H', id: 916 },
  THOR_RAGNAROK: { name: 'Thor: Ragnarok', nickname: 'Th3', id: 917 },
  BLACK_PANTHER: { name: 'Black Panther', nickname: 'BP', id: 918 },
  AVENGERS_INFINITY_WAR: { name: 'Avengers: Infinity War', nickname: 'AV:IW', id: 919 },
  ANT_MAN_AND_THE_WASP: { name: 'Ant-Man and the Wasp', nickname: 'AM:W', id: 920 },
  CAPTAIN_MARVEL: { name: 'Captain Marvel', nickname: 'CM', id: 921 },
  AVENGERS_ENDGAME: { name: 'Avengers: Endgame', nickname: 'AV:E', id: 922 },
