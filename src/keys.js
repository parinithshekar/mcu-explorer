...
const movieMasterData = {
  IRON_MAN: { name: 'Iron Man', nickname: 'IM1', id: 901, color: 'red' },
  THE_INCREDIBLE_HULK: { name: 'The Incredible Hulk', nickname: 'H1', id: 902, color: 'red' },
  IRON_MAN_2: { name: 'Iron Man 2', nickname: 'IM2', id: 903, color: 'red' },
  THOR: { name: 'Thor', nickname: 'Th1', id: 904, color: 'red' },
  ...
  AVENGERS: { name: 'The Avengers', nickname: 'AV', id: 906, color: 'red' },
  IRON_MAN_3: { name: 'Iron Man 3', nickname: 'IM3', id: 907, color: 'red' },
  THOR_DARK_WORLD: { name: 'Thor: The Dark World', nickname: 'Th2', id: 908, color: 'red' },
  ...
  ANT_MAN: { name: 'Ant-Man', nickname: 'AM', id: 912, color: 'red' },
  ...
  DOCTOR_STRANGE: { name: 'Doctor Strange', nickname: 'DS', id: 914, color: 'red' },
  ...
  THOR_RAGNAROK: { name: 'Thor: Ragnarok', nickname: 'Th3', id: 917, color: 'red' },
  BLACK_PANTHER: { name: 'Black Panther', nickname: 'BP', id: 918, color: 'red' },
  ...
  ANT_MAN_AND_THE_WASP: { name: 'Ant-Man and the Wasp', nickname: 'AM:W', id: 920, color: 'red' },
  CAPTAIN_MARVEL: { name: 'Captain Marvel', nickname: 'CM', id: 921, color: 'red' },
  AVENGERS_ENDGAME: { name: 'Avengers: Endgame', nickname: 'AV:E', id: 922, color: 'red' },
